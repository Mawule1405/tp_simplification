#lang scheme
(require "Application_TP_simplification.rkt")                        
(require "Outils_TP_simplification.rkt")                                         
(require racket/gui)
(require racket/draw)
...
(define ACCUEIL (new frame% [label "Simplicateur d'expression"]                          ;definition de la fenetre d'accueil
                          [width 600]
                          [height 400]
                          [style '(no-caption no-system-menu no-resize-border)]
                     ))
...
(define FRAME (new frame% [label "TP Simplification arithmétique"]       ;definition de la fenetre principale
              [width 650]
              [height 400]
              [border 5]
...
(send Texte_accueil set-label "BIENVENU SUR SIMPLIFICATEUR D'EXPRESSION")
(sleep/yield 4)
